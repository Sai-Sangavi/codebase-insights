...
from codebase_insights.stats.file_walker import WalkedFile
from codebase_insights.stats.stats import count_files_by_language, count_loc_by_language, count_tests, inventory_config_files, inventory_dependency_manifests
...
def test_count_pyproject_toml_single_line_array():
    from codebase_insights.stats.stats import _count_pyproject_toml
...
from codebase_insights.stats.stats import (
    check_pr_templates,
...
def test_run_git_returns_empty_string_when_repo_path_does_not_exist():
    from codebase_insights.stats.stats import _run_git
