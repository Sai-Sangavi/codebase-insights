from codebase_insights.stats.file_walker import WalkedFile, classify_language, walk_files
...
def test_walk_files_prunes_excluded_directories_without_descending(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("codebase_insights.stats.file_walker.os.walk", spying_walk)
