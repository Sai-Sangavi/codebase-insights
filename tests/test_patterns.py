...
from codebase_insights.llm.patterns import ClaudeCLIError, narrow_candidates, run_claude_cli
...
def test_synthesize_pattern_parses_full_json_response():
    from codebase_insights.llm.patterns import synthesize_pattern
...
def test_analyze_category_default_reads_narrowed_files_and_synthesizes(tmp_path):
    from codebase_insights.llm.patterns import analyze_category_default
...
from codebase_insights.llm.patterns import (
    analyze_category,
    describe_category,
    merge_batch_results,
